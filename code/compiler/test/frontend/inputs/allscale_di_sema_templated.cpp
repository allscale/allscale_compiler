...
int main() {
	...
	#pragma test expect_ir(R"(
		...
		{
			var ref<IMP_TemplatedDI<ref<real<8>,f,f,qualified>,ref<int<4>,f,f,qualified>>,f,f,plain> v0 = instantiate(lit("target_type" : IMP_TemplatedDI<ref<real<8>,f,f,qualified>,ref<int<4>,f,f,qualified>>::()), lit("IMP_TemplatedDI::ctor" : IMP_TemplatedDI<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))(ref_decl(type_lit(ref<IMP_TemplatedDI<ref<real<8>,f,f,qualified>,ref<int<4>,f,f,qualified>>,f,f,plain>)));
			instantiate(lambda_name IMP_TemplatedDI<ref<real<8>,f,f,qualified>,ref<int<4>,f,f,qualified>>::IMP__operator_subscript_, lit("IMP_TemplatedDI::IMP__operator_subscript_" : IMP_TemplatedDI<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::('T_0_1) -> ref<'T_0_0,f,f,cpp_ref>))(v0, 0) materialize  = 0.0E+0;
		}
	)")
	{
	...
	#pragma test expect_ir(R"(
		{
			var ref<IMP_TemplatedDI<ref<real<8>,f,f,qualified>,ref<int<4>,f,f,qualified>>,f,f,plain> v0 = instantiate(lit("target_type" : IMP_TemplatedDI<ref<real<8>,f,f,qualified>,ref<int<4>,f,f,qualified>>::()), lit("IMP_TemplatedDI::ctor" : IMP_TemplatedDI<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::()))(ref_decl(type_lit(ref<IMP_TemplatedDI<ref<real<8>,f,f,qualified>,ref<int<4>,f,f,qualified>>,f,f,plain>)));
			instantiate(lit("target_type" : const IMP_TemplatedDI<ref<real<8>,f,f,qualified>,ref<int<4>,f,f,qualified>>::() -> unit), lit("IMP_TemplatedDI::IMP_someOtherMethod" : const IMP_TemplatedDI<ref<'T_0_0,'T_0_0_a,'T_0_0_b,'T_0_0_c>,ref<'T_0_1,'T_0_1_a,'T_0_1_b,'T_0_1_c>>::() -> unit))(v0);
		}
	)")
	{
		TemplatedDI<double, int> di;
